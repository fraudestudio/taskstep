...
else echo '<p>A problem has been encountered during the installation process. You can ask for assistance at the <a href="http://taskstep.com/forum/">support forums</a>. Please give the details of any problems, quoting the bits above. If there are any bits in bold in the red boxes then you must quote them in order for us to help you.</p>'; 
