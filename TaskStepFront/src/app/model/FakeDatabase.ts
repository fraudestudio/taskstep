...
export class FakeDatabase {
    ...
    public static Items : Item[] = [new Item(false,0,"test","",new Context("test"),new Project("test"),new Date(),"test","test"),new Item(false,0,"test","test",new Context("test"),new Project("test"),new Date(),"test","test"),new Item(false,0,"test","test",new Context("test"),new Project("test"),new Date(),"test","test")];
